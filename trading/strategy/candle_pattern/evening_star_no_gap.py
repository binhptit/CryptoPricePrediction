...
class EveningStarNoGap(BasePattern):
    """
    ...
    def __init__(self, candlesticks: List[CandleStick]):
        ...
        self.trend = "bearish"
        self.pattern_name = "EveningStarNoGap"
        self.no_candles = 3
    ...
    def run(self):
        ...
        for i in range(len(self.candlesticks) - 2):
            ...
            # Second day A small-bodied candle that gaps above the bodies of the
            # adjacent candles. It can be either black or white.
            # Last day A tall black candle that gaps below the prior candle and
            # closes at least halfway down the body of the white candle    
                    
            # candlestick_0 is white and tall
            if candlestick_0.close > candlestick_0.open and body_0 >= average_body:
                if candlestick_1.close >= candlestick_1.open:
                    if body_2 >= average_body and \
                        ...
                        candlestick_2.close <= candlestick_0.open + (abs(candlestick_0.open - candlestick_0.close)) / 2:
