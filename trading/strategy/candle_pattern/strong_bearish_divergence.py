...
class StrongBearishDivergence(RsiDivergence):
    """
        Find the strong Bearish divergence pattern.
    ...
    def __init__(self, candlesticks: List[CandleStick], divergence_type="hh"):
        ...
        self.trend = "bearish"
        self.pattern_name = "strong_bearish_divergence"
        self.no_candles = 1
    
    def run(self):
        """
            Finds the Strong Bearish divergence pattern.

            Return:
                list[int]: index of the candlestick where the Strong Bearish divergence was found
        """
    ...
    def __repr__(self) -> str:
        return "Strong Bearish divergence pattern"