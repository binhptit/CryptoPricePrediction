...
def task(symbol, time_frames, data_collector, allow_pattern_dict, telegram_notification):
    ...
    while True:
        ...
        # Sleep while Saturday or Sunday
        ...
        if minute_value in [i for i in range(56, 59, 1)] and '1h' in time_frames and current_time.hour != last_hour_1h_process:
        ...
        if hour_value in [23, 3, 7, 11, 15, 19]  and minute_value in [i for i in range(56, 59, 1)] and '4h' in time_frames \
        ...
        if hour_value in [23] and minute_value in [i for i in range(56, 59, 1)] and '1d' in time_frames and current_time.day != last_day_process:
        ...
        if hour_value in [23] and current_time.weekday() == 0 and minute_value in [i for i in range(56, 59, 1)] and '1w' in time_frames and current_time.day != last_day_week_process:
